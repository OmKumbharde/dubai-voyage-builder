    ...
    <div className="flex h-screen w-64 flex-col bg-gradient-primary text-white">
      ...
      <nav className="flex-1 space-y-1 p-4">
        <div className="space-y-1">
          <h3 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3">Main Menu</h3>
        ...
        <div className="space-y-1 pt-6">
          <h3 className="text-xs font-semibold text-white/60 uppercase tracking-wider mb-3">Management</h3>
          {adminItems.map((item) => (
            <NavLink
              key={item.name}
              to={item.href}
